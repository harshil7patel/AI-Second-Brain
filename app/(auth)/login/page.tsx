...
import { Brain, Loader2, Sparkles, Zap, Shield, Lock, FileText, MessageSquare } from "lucide-react"
...
// Animated network visualization nodes
const nodes = [
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.session) {
        ...
        setErrorMsg("No session returned. Try again.")
        setLoading(false)
      }
    } catch (err: any) {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 px-12 max-w-lg">
          ...
          >
            ...
            <p className="text-xl text-text-1 font-semibold mb-2">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            ...
            <p className="text-text-2 text-sm mb-6">Sign in to your knowledge base</p>
          ...
          {/* Features */}
          <motion.div
            className="flex justify-center gap-6 mt-8 text-xs text-text-3"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
